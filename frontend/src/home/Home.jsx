    ...
    <div>
      ...
      <section className="relative overflow-hidden bg-white   min-h-[88vh] flex items-center">
        ...
        <div className="max-w-6xl mx-auto px-6 py-20 grid md:grid-cols-2 gap-12 items-center w-full">
          ...
          <div className="animate-fade-up">
            <div className="badge-orange  text-white mb-6 inline-flex">
              <span className="w-2 h-2 rounded-full bg-orange animate-pulse" />
              Now delivering in 30 mins
            </div>
            <h1 className="font-display font-extrabold text-5xl md:text-6xl text-chalk leading-[1.05] tracking-tight mb-6">
              Freshly Steamed
              <br />
              <span className="text-orange">MoMos</span> Delivered
              <br />
              to You
            </h1>
            ...
            <div className="flex gap-8 mt-12 pt-8 border-t border-dark-3">
              {[
                ...
                <div key={s.label}>
                  <div className="font-display font-extrabold text-2xl text-chalk">
                    {s.value}
                  </div>
          ...
          <div className="hidden md:flex items-center justify-center relative">
            ...
            {/* Floating badges */}
            <div
              className="absolute top-8 right-4 bg-dark-2 border border-mid rounded-xl px-4 py-3 shadow-card animate-fade-up"
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="font-display font-bold text-chalk text-sm">
                    Free Delivery
                  </div>
            ...
            <div
              className="absolute bottom-12 left-2 bg-dark-2 border border-mid rounded-xl px-4 py-3 shadow-card animate-fade-up"
      ...
      <section className="border-y border-dark-3 bg-dark-2">
        <div className="max-w-6xl mx-auto px-6 py-8 grid grid-cols-2 md:grid-cols-4 gap-6">
          {[
            {
              icon: <Truck size={22} className="text-orange" />,
              title: "Fast Delivery",
      ...
      <section className="max-w-6xl mx-auto px-6 mb-16">
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-orange to-orange-light p-10 md:p-14 flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="absolute right-0 top-0 bottom-0 text-[160px] leading-none opacity-10 pointer-events-none select-none">
            🍜
          </div>
          <div>
            ...
            <p className="text-white/80 text-lg">
              Get your favourite momos in under 30 minutes.
            </p>
          </div>
          <Link
            to="/menu"
